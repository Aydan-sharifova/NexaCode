...
export interface AdminUser{id:string;displayName:string;userName:string;email:string;isSuspended:boolean;banExpiresAt?:string;roles:string[];createdAt:string;lastSeen:string}
export interface AdminUserDetails{id:string;firstName:string;lastName:string;userName:string;email:string;bio?:string;avatarUrl?:string;isSuspended:boolean;suspensionReason?:string;banExpiresAt?:string;roles:string[];projectCount:number;createdAt:string;lastSeen:string}
...
export const adminApi={
 ...
 suspension:(id:string,suspended:boolean,reason?:string,expiresAt?:string)=>apiClient.put<void>(`/admin/users/${id}/suspension`,{suspended,reason,expiresAt}),
