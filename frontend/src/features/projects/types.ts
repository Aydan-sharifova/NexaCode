...
export interface ProjectListItem { id: string; name: string; description?: string; defaultLanguage: string; isPublic: boolean; currentUserRole: ProjectRole; memberCount: number; createdAt: string; updatedAt?: string; deadlineAt?: string; status: ProjectStatus; isReadOnly: boolean; }
