...
public sealed record ChatMessageItem(Guid Id, Guid ConversationId, ChatUser Sender, string Content, DateTime CreatedAt, bool IsDeleted, IReadOnlyList<Guid> ReadByUserIds);
